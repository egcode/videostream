//
//  ViewController+Receive.swift
//  VideoStream
//
//  Created by Eugene G on 2/23/19.
...
extension ViewController {
    ...
    func viewDidLoadReceive() {

        videoLayer = AVSampleBufferDisplayLayer()
        
        if let layer = videoLayer {
            layer.frame = self.receivedView.bounds
            ...
            self.receivedView.layer.addSublayer(layer)
        }
    }
